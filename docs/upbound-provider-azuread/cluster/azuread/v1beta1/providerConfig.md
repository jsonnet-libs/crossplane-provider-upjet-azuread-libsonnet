---
permalink: /upbound-provider-azuread/cluster/azuread/v1beta1/providerConfig/
---

# azuread.v1beta1.providerConfig
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withMsiEndpoint(msiEndpoint)`](#fn-specwithmsiendpoint)
  * [`fn withOidcTokenFilePath(oidcTokenFilePath)`](#fn-specwithoidctokenfilepath)
...
### fn spec.withMsiEndpoint

```ts
withMsiEndpoint(msiEndpoint)
```

"MSIEndpoint is the optional path to a custom endpoint for\nManaged Service Identity."

### fn spec.withOidcTokenFilePath
