---
permalink: /upbound-provider-azuread/cluster/directoryroles/v1beta1/roleAssignment/
---

# directoryroles.v1beta1.roleAssignment
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAppScopeId(appScopeId)`](#fn-specforproviderwithappscopeid)
    * [`fn withDirectoryScopeId(directoryScopeId)`](#fn-specforproviderwithdirectoryscopeid)
    ...
    * [`obj spec.forProvider.roleIdRef`](#obj-specforproviderroleidref)
      * [`fn withName(name)`](#fn-specforproviderroleidrefwithname)
      * [`obj spec.forProvider.roleIdRef.policy`](#obj-specforproviderroleidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderroleidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderroleidrefpolicywithresolve)
    * [`obj spec.forProvider.roleIdSelector`](#obj-specforproviderroleidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderroleidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderroleidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderroleidselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.roleIdSelector.policy`](#obj-specforproviderroleidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderroleidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderroleidselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAppScopeId(appScopeId)`](#fn-specinitproviderwithappscopeid)
    * [`fn withDirectoryScopeId(directoryScopeId)`](#fn-specinitproviderwithdirectoryscopeid)
    ...
    * [`obj spec.initProvider.roleIdRef`](#obj-specinitproviderroleidref)
      * [`fn withName(name)`](#fn-specinitproviderroleidrefwithname)
      * [`obj spec.initProvider.roleIdRef.policy`](#obj-specinitproviderroleidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderroleidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderroleidrefpolicywithresolve)
    * [`obj spec.initProvider.roleIdSelector`](#obj-specinitproviderroleidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderroleidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderroleidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderroleidselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.roleIdSelector.policy`](#obj-specinitproviderroleidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderroleidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderroleidselectorpolicywithresolve)
...
### fn spec.forProvider.withAppScopeId

```ts
withAppScopeId(appScopeId)
```
...
### fn spec.forProvider.withDirectoryScopeId

```ts
withDirectoryScopeId(directoryScopeId)
```
...
## obj spec.forProvider.roleIdRef

"Reference to a Role in directoryroles to populate roleId."

### fn spec.forProvider.roleIdRef.withName
...
## obj spec.forProvider.roleIdRef.policy

"Policies for referencing."

### fn spec.forProvider.roleIdRef.policy.withResolution
...
### fn spec.forProvider.roleIdRef.policy.withResolve
...
## obj spec.forProvider.roleIdSelector

"Selector for a Role in directoryroles to populate roleId."

### fn spec.forProvider.roleIdSelector.withMatchControllerRef
...
### fn spec.forProvider.roleIdSelector.withMatchLabels
...
### fn spec.forProvider.roleIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.roleIdSelector.policy

"Policies for selection."

### fn spec.forProvider.roleIdSelector.policy.withResolution
...
### fn spec.forProvider.roleIdSelector.policy.withResolve
...
### fn spec.initProvider.withAppScopeId
...
### fn spec.initProvider.withDirectoryScopeId
...
## obj spec.initProvider.roleIdRef

"Reference to a Role in directoryroles to populate roleId."

### fn spec.initProvider.roleIdRef.withName
...
## obj spec.initProvider.roleIdRef.policy

"Policies for referencing."

### fn spec.initProvider.roleIdRef.policy.withResolution
...
### fn spec.initProvider.roleIdRef.policy.withResolve
...
## obj spec.initProvider.roleIdSelector

"Selector for a Role in directoryroles to populate roleId."

### fn spec.initProvider.roleIdSelector.withMatchControllerRef
...
### fn spec.initProvider.roleIdSelector.withMatchLabels
...
### fn spec.initProvider.roleIdSelector.withMatchLabelsMixin
...
## obj spec.initProvider.roleIdSelector.policy

"Policies for selection."

### fn spec.initProvider.roleIdSelector.policy.withResolution
...
### fn spec.initProvider.roleIdSelector.policy.withResolve
