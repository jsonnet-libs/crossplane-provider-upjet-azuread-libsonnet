---
permalink: /upbound-provider-azuread/cluster/serviceprincipals/v1beta1/password/
---

# serviceprincipals.v1beta1.password
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withEndDateRelative(endDateRelative)`](#fn-specforproviderwithenddaterelative)
    * [`fn withRotateWhenChanged(rotateWhenChanged)`](#fn-specforproviderwithrotatewhenchanged)
    * [`fn withRotateWhenChangedMixin(rotateWhenChanged)`](#fn-specforproviderwithrotatewhenchangedmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withEndDateRelative(endDateRelative)`](#fn-specinitproviderwithenddaterelative)
    * [`fn withRotateWhenChanged(rotateWhenChanged)`](#fn-specinitproviderwithrotatewhenchanged)
    * [`fn withRotateWhenChangedMixin(rotateWhenChanged)`](#fn-specinitproviderwithrotatewhenchangedmixin)
...
### fn spec.forProvider.withEndDateRelative

```ts
withEndDateRelative(endDateRelative)
```

"A relative duration for which the password is valid until, for example 240h (10 days) or 2400h30m. Changing this field forces a new resource to be created.\nA relative duration for which the password is valid until, for example `240h` (10 days) or `2400h30m`. Changing this field forces a new resource to be created"

### fn spec.forProvider.withRotateWhenChanged

```ts
withRotateWhenChanged(rotateWhenChanged)
```
...
### fn spec.forProvider.withRotateWhenChangedMixin

```ts
withRotateWhenChangedMixin(rotateWhenChanged)
```
...
### fn spec.initProvider.withEndDateRelative
...
### fn spec.initProvider.withRotateWhenChanged
...
### fn spec.initProvider.withRotateWhenChangedMixin
