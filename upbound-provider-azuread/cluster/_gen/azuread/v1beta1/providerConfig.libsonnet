{
  ...
  '#':: d.pkg(name='providerConfig', url='', help='"A ProviderConfig configures the AzureAD provider."'),
  ...
  spec: {
    ...
    '#withClientID':: d.fn(help="\"ClientID is the user-assigned managed identity's ID\\nwhen Credentials.Source is `InjectedIdentity`. If unset and\\nCredentials.Source is `InjectedIdentity`, then a system-assigned\\nmanaged identity is used.\\nRequired if Credentials.Source is OIDCTokenFile.\"", args=[d.arg(name='clientID', type=d.T.string)]),
    withClientID(clientID): { spec+: { clientID: clientID } },
    '#withEnvironment':: d.fn(help='"The Cloud Environment which should be used. Possible values are \\"public\\",\\n\\"usgovernment\\", \\"german\\", and \\"china\\". Defaults to \\"public\\"."', args=[d.arg(name='environment', type=d.T.string)]),
    withEnvironment(environment): { spec+: { environment: environment } },
    '#withMsiEndpoint':: d.fn(help='"MSIEndpoint is the optional path to a custom endpoint for\\nManaged Service Identity."', args=[d.arg(name='msiEndpoint', type=d.T.string)]),
    withMsiEndpoint(msiEndpoint): { spec+: { msiEndpoint: msiEndpoint } },
    '#withOidcTokenFilePath':: d.fn(help='"OIDCTokenFilePath is the optional path to a token file\\nthat allows to access a managed identity."', args=[d.arg(name='oidcTokenFilePath', type=d.T.string)]),
    withOidcTokenFilePath(oidcTokenFilePath): { spec+: { oidcTokenFilePath: oidcTokenFilePath } },
    '#withTenantID':: d.fn(help='"TenantID is the Azure AD tenant ID to be used.\\nIf unset, tenant ID from Credentials will be used.\\nRequired if Credentials.Source is InjectedIdentity, OIDCTokenFile."', args=[d.arg(name='tenantID', type=d.T.string)]),
