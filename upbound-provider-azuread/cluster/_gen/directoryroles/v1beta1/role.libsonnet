{
  ...
  spec: {
    ...
    forProvider: {
      '#withDisplayName':: d.fn(help='"The display name of the directory role to activate. Changing this forces a new resource to be created.\\nThe display name of the directory role"', args=[d.arg(name='displayName', type=d.T.string)]),
